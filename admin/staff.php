...
<body>
    <div class="addroomsection">
        <form action="" method="POST">
            <label for="troom">ชื่อพนักงาน :</label>
            <input type="text" name="staffname" class="form-control">

            <label for="bed">ตำแหน่ง :</label>
            <select name="staffwork" class="form-control">
                <option value selected>เลือกตำแหน่ง</option>
                <option value="ผู้ดูแลระบบ">ผู้ดูแลระบบ</option>
                <option value="ผู้ดูแลสัตว์เลี้ยง">ผู้ดูแลสัตว์เลี้ยง</option>
                <option value="พนักงานทำความสะอาด">พนักงานทำความสะอาด</option>
                <option value="พนักงานให้อาหาร">พนักงานให้อาหาร</option>
            </select>

            <button type="submit" class="btn btn-success" name="addstaff">เพิ่มพนักงาน</button>
        </form>
        ...
        while ($row = mysqli_fetch_array($re)) {
                echo "<div class='roombox'>
						<div class='text-center no-boder'>
                            ...
                            <a href='staffdelete.php?id=". $row['id'] ."'><button class='btn btn-danger'>ลบ</button></a>
						</div>
                    </div>";
        }
        ?>
